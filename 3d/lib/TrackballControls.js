...
THREE.TrackballControls = function ( object, domElement ) {
    ...
    function scrollHandler(event) {
        ...
        _zoomStart.y = _zoomEnd.y + delta * _this.zoomSpeed * _this.dynamicDampingFactor / 5;
    };
    ...
    this.domElement.addEventListener('DOMMouseScroll', scrollHandler, false);
    this.domElement.addEventListener('mousewheel', scrollHandler, false);

    this.domElement.addEventListener('gesturechange', function (event) {
        _zoomStart.y = _zoomEnd.y + (event.scale - 1) * _this.zoomSpeed * _this.dynamicDampingFactor / 2;
    }, false);
    ...
    this.domElement.addEventListener('touchcancel', mouseup, false);
